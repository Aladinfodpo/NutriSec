    ...
    Surface(color = MaterialTheme.colorScheme.background) {
        Column(modifier = modifier.fillMaxSize()) {
            ...
            DrawerButton(
                ...
                isSelected = currentRoute == NutriSecDestinations.STATISTICS_ROUTE,
                action = {
        ...
        DrawerFooter(modifier = modifier.fillMaxSize())
    }
}
...
private fun DrawerFooter(
    ...
    Column(
        ...
        Text(
            text = "NutriSec v" + stringResource(id = R.string.version),
            color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f)
        )
    }
}
